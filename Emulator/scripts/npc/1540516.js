...
var items = new Array(1142268, 1142593, 1402214 , 1452220, 1462208, 1492194, 1432182, 1482183, 1382226, 1472230, 1332242, 1342087, 1422156, 1122012 );
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
                var chat= "#e#r가끔 뽑기가 무시 당하는 경우가 있습니다.\r\n올텟 3000 공마 500#n#k\r\n#r후원아이템 뽑기#k에서는 #b여러가지 후원시스템에 사용가능한 아이템들이 나옵니다.\r\n\r\n아이템 리스트 : #v1142268# #v1142593# #v1402214# #v1452220# #v1462208# #v1492194# #v1432182# #v1482183# #v1382226# #v1472230# #v1332242# #v1342087# #v1422156# #v1122012# \r\n\r\n#r#e뽑기 비용#n#k으로는 5만 포인트가 필요합니다.\r\n";
	...
	if (cm.getPlayer().getRC() >= 10000) {
			...
			makeSponserItem(items[Math.floor(Math.random() * items.length)], 3000,500,0);
