var DEBUG = false;var HIDDEN_ITEM = 4031325, MINE_ITEM = 5021013, EXPLODED_ITEM = 5120009;
var Modes = [
    //MAX COL = 7
...
function ConstructBoardString() {
    var ret = "#d즐겜요~ 여기보이는숫자만큼 찾으세요>#k#e->#k " + LeftToBeRevealed + "\r\n";
    var num = 0;
    for (var i = 0;i < NumCols;i++) {
        for (var j = 0;j < NumRows;j++) {
