...
function action(mode, type, selection) {
	...
	if (status == 0) {
		...
		jessica += "#b쥬얼 크레프트 재료는 #i4001780##t4001780# 뽑기를 통해서 구할수 있어 ";
        ...
        if (selection == 17) {
               ...
               cm.gainSponserItem(1112763,'[쥬얼크래프트]',50,10,0);
...
cm.gainSponserItem(1112764,'[쥬얼크래프트]',50,10,0);
...
cm.gainSponserItem(1112765,'[쥬얼크래프트]',50,10,0);
...
cm.gainItem(1112766,'[쥬얼크래프트]',50,10,0);
...
cm.gainSponserItem(1112767,'[쥬얼크래프트]',50,10,0);
cm.sendOk("#bC급 쥬얼 크레프트 링#k 합성이 완료되었어");
cm.dispose();
}else{
    cm.sendOk("#bC급 쥬얼 크레프트 링#k 을 합성하기에는 재료가 부죽한거같은대?");
...
cm.gainSponserItem(1112768,'[쥬얼크래프트]',50,10,0);
cm.sendOk("#bC급 쥬얼 크레프트 링#k 합성이 완료되었어");
cm.dispose();
}else{
    cm.sendOk("#bC급 쥬얼 크레프트 링#k 을 합성하기에는 재료가 부죽한거같은대?");
...
cm.gainSponserItem(1112769,'[쥬얼크래프트]',50,10,0);
cm.sendOk("#bC급 쥬얼 크레프트 링#k 합성이 완료되었어");
cm.dispose();
}else{
    cm.sendOk("#bC급 쥬얼 크레프트 링#k 을 합성하기에는 재료가 부죽한거같은대?");
...
cm.gainSponserItem(1112770,'[쥬얼크래프트]',50,10,0);
cm.sendOk("#bC급 쥬얼 크레프트 링#k 합성이 완료되었어");
cm.dispose();
}else{
    cm.sendOk("#bC급 쥬얼 크레프트 링#k 을 합성하기에는 재료가 부죽한거같은대?");
...
cm.gainSponserItem(1112771,'[쥬얼크래프트]',50,10,0);
cm.sendOk("#bC급 쥬얼 크레프트 링#k 합성이 완료되었어");
cm.dispose();
}else{
    cm.sendOk("#bC급 쥬얼 크레프트 링#k 을 합성하기에는 재료가 부죽한거같은대?");
...
cm.gainSponserItem(1112772,'[쥬얼크래프트]',50,10,0);
cm.sendOk("#bC급 쥬얼 크레프트 링#k 합성이 완료되었어");
cm.dispose();
}else{
    cm.sendOk("#bC급 쥬얼 크레프트 링#k 을 합성하기에는 재료가 부죽한거같은대?");
...
cm.gainSponserItem(1112773,'[쥬얼크래프트]',50,10,0);
cm.sendOk("#bC급 쥬얼 크레프트 링#k 합성이 완료되었어");
cm.dispose();
}else{
    cm.sendOk("#bC급 쥬얼 크레프트 링#k 을 합성하기에는 재료가 부죽한거같은대?");
...
cm.gainSponserItem(1112774,'[쥬얼크래프트]',50,10,0);
cm.sendOk("#bC급 쥬얼 크레프트 링#k 합성이 완료되었어");
cm.dispose();
}else{
    cm.sendOk("#bC급 쥬얼 크레프트 링#k 을 합성하기에는 재료가 부죽한거같은대?");
...
cm.gainSponserItem(1112775,'[쥬얼크래프트]',50,10,0);
cm.sendOk("#bC급 쥬얼 크레프트 링#k 합성이 완료되었어");
cm.dispose();
}else{
    cm.sendOk("#bC급 쥬얼 크레프트 링#k 을 합성하기에는 재료가 부죽한거같은대?");
...
cm.gainSponserItem(1112776,'[쥬얼크래프트]',50,10,0);
cm.sendOk("#bC급 쥬얼 크레프트 링#k 합성이 완료되었어");
cm.dispose();
}else{
    cm.sendOk("#bC급 쥬얼 크레프트 링#k 을 합성하기에는 재료가 부죽한거같은대?");
...
cm.gainSponserItem(1112777,'[쥬얼크래프트]',50,10,0);
cm.sendOk("#bC급 쥬얼 크레프트 링#k 합성이 완료되었어");
cm.dispose();
}else{
    cm.sendOk("#bC급 쥬얼 크레프트 링#k 을 합성하기에는 재료가 부죽한거같은대?");
...
cm.gainSponserItem(1112778,'[쥬얼크래프트]',50,10,0);
cm.sendOk("#bC급 쥬얼 크레프트 링#k 합성이 완료되었어");
cm.dispose();
}else{
    cm.sendOk("#bC급 쥬얼 크레프트 링#k 을 합성하기에는 재료가 부죽한거같은대?");
