...
if (cm.getPlayer().getLevel() >= 200) {
	var text = "#fn나눔고딕 Extrabold#\r\n#d#h ##k 님 안녕하세요.\r\n\r\n#b검색#k #fs14##r1번#k#fs11# 을 통해 #b모든 캐시 아이템#k 을 구입 해보세요.\r\n"
            text+= "#Cgray#(아이템의 가격은 캐시 아이템 한 개당#k #r300 만 메소 + 썸머리밋 코인 30 개#k #Cgray#입니다.)#k\r\n\r\n#fs12#"
            text+= "#L0##d#h ##k : 아이템을 구입 하겠습니다."
            cm.sendSimple(text);
} else {
cm.sendOk("#fn나눔고딕 Extrabold##r캐시템 검색 구매 기능은 레벨 200 이상만 이용 가능합니다.");
cm.dispose();
}
	...
	cm.dispose();
        ...
        cm.sendOk ("#fn나눔고딕 Extrabold##r구매를 위한 메소 또는 썸머리밋 코인이 부족합니다.#k");
        cm.dispose();
	}
