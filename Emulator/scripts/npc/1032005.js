var list1 = [1112937,1112901,1112908,1112924,1112925,1112926]; // 캐릭터 반지 아이템
var list2 = [1002186,1012289,1032024,1022079,1072153,1082102,1102039]; // 투명 세트
var list3 = [1004540,1052948,1102837,1702594]; // 오르카 세트
var list4 = [1003109,1052275,1072448,1102245,1702275]; // 로얄 레인보우 세트
...
var list21 = [1004470,1052912,1102816,1702576]; // 쿵떡 세트
...
function showInfo() {
	...
	//text += "#L999999##e#r"+time+"『다른 후원아이템 보기』"+time+" (500원 이상 아이템)#k\r\n\r\n#l";
        ...
        text += showItemList(3,0,list3,list3.length,true);        text += showItemList(4,0,list4,list4.length,true);         
        text += showItemList(6,0,list6,list6.length,true);        text += showItemList(7,0,list7,list7.length,true);
        text += showItemList(8,0,list8,list8.length,true);        text += showItemList(9,0,list9,list9.length,true);                
        ...
        text += showItemList2(18,list18_5,0);	text += showItemList(19,0,list19,list19.length,true);
