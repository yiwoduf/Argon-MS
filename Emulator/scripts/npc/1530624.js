var status = -1;
var cost = 846000000; // 소환가격
var mob = 8920000; //소환될 몹 코드
var check = "카오스 블러디 퀸";//체크될 몹 이름
map = 105200710;//맵 코드
var x = 34;//x좌표
var y = 135;//y좌표
var hp = "2 8 2 0 억";
...
function action(mode, type, selection) {
 ...
 if (status == 0) {
  ...
  cm.sendSimple("#fn나눔고딕 Extrabold##d"+check+"#k 은 하루마다#Cgray##fs10#(12시 기준) #fs15##r3번#k #fs11#만 소환이 가능합니다.\r\n\r\n                                      #fs13##d체력#k : #r"+hp+"#k\r\n\r\n       #L1##fs13##r" + cost + " 메소#k - #d"+check+" 소환#k#l\r\n                  #L2##fs11##b"+ServerConstants.serverName+" 전용 광장으로 가기#k#l\r\n");
    } else {
   cm.dispose();
}
  } else if(selection == 1) {
 ...
 cm.dispose();
	...
	cm.sendOk("#fn나눔고딕 Extrabold##d"+check+"#k 은 하루마다#Cgray##fs10#(12시 기준) #fs15##r3번#k #fs11#만 소환이 가능합니다.");
	cm.dispose();
	}
	}
  } else if (selection == 2) {
