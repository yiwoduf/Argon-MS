...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
	if (status == 0) {
		var huwon = "   #e안녕하세요. #e#b#h0#님!!!#n#k\r\n   저희 #e#r에이플러스#n#k에서는 #e#b플레이#n#k하시는 분들 의 #e#r편의#n#k를 위하여\r\n   #e#b폭업사냥터#n#k를 만들었습니다.\r\n\r\n";
		if (cm.getPlayer().getMapId() == 927000100) {
			...
			huwon += "#L100000000##e#b헤네시스로 돌아가기\r\n\r\n";
			huwon += "#L3##r(몬스터가 없는데 있다고 뜰시 여기를 클릭해 주세요.)";
		} else if (cm.getPlayer().getMapId() == 927000110) {
			huwon += "   #e#b렉 방지#n#k를 위하여 한 번에 #e#r50마리#n#k씩 #e#b소환#n#k 가능합니다.\r\n\r\n";
			huwon += "#L2##e#b레벨 151 ~ 200 폭업몬스터 소환하기\r\n";
			huwon += "#L100000000##e#b헤네시스로 돌아가기\r\n\r\n";
			huwon += "#L3##r(몬스터가 없는데 있다고 뜰시 여기를 클릭해 주세요.)";
		} else {
	    	huwon += "   에이플러스 유저 모두 #e#b폭업사냥터#n#k를 #e#b이용#n#k하실 수\r\n   있습니다. 어때여? #e#b한 번#n#k #e#r이용#n#k해 보실래요?\r\n\r\n";
		huwon += "#L927000100##e#b레벨 1 ~ 150 폭업사냥터 이동하기(초보)\r\n";
 //               huwon += "#L927000110##e#b레벨 151 ~ 200 폭업사냥터 이동하기(초보)\r\n";
		huwon += "#L273060300##e#b레벨 200 ~ 250 폭업사냥터 이동하기(피통 10억)\r\n";
                huwon += "#L241000206##e#r레벨 200 ~ 250 폭업사냥터 이동하기(피통 100억)\r\n";
		}
		cm.sendSimple(huwon);
	} else if (status == 1) {
...
//				
			...
			if (cm.getPlayerCount(selection) > 0) {
				...
				cm.dispose();
			} else if (cm.haveItem(4310153, 1)) {
				cm.warp(selection);
				cm.dispose();
			} else {
				cm.sendOk("#e#b#i4310153# #z4310153##n#k이 있는지 #e#r확인#n#k해 주세요.");
				cm.dispose();
			}		
		}
	}
