...
var arr = new Array(1142268, 1402214 , 1452220, 1462208, 1492194, 1432182, 1482183, 1382226, 1472230, 1332242, 1342087, 1422156, 1122012);
...
function action(m,t,s){
	...
	if(status == 0){
		...
		if(sel != 1){
			...
			stat = s*10;
			s!=10?cost = 10000+(stat*2000):cost=300000;
			...
			var euro = "";
			var ucost;
			next=="언리미티드"?ucost=30000:ucost=100000;
		...
		if(cm.canHold(item)){
			...
			slot = slot/1000;
			grade=="최상급"?cost=30000:cost=100000;
