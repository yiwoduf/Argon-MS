...
cm.sendSimple("#r#e#h #유저님 안녕하세요^^#n#k\r\m\n#r#n#d#e저는 스킬마스터 담당 륀느 입니다.#n#k\r\n#g#e스킬마스터 할 직업을 선택해주세요♥#n#k" +"#k\r\n#L823##d#e[베틀메이지]스킬마스터#n#k" +"#k\r\n#L824##d#e[와헌]스킬마스터#n#k" +"#k\r\n#L825##d#e[메카닉]스킬마스터#n#k" +"#k\r\n#L814##d#e[데몬슬레이어]스킬마스터#n#k");
  ...
  cm.teachSkill(1000006,10,10); // HP증가 -- 1차스킬끝
  ...
  cm.teachSkill(1101007,20,20); // 파워 리플렉션
  cm.teachSkill(1101011,20,20); // 브랜디쉬
  cm.teachSkill(1101008,10,10); // 그라운드 스매시
  ...
  cm.teachSkill(1121011,30,30); // 용사의 의지
  ...
  cm.teachSkill(13000000,20,20); // 크리티컬 샷 -- 1차스킬
  cm.teachSkill(13000001,15,15); // 아처 마스터리
  cm.teachSkill(13001004,10,10); // 스톰
  cm.teachSkill(13001003,20,20); // 더블샷
  cm.teachSkill(12000005,10,10); // HP증가 -- 1차스킬끝
  cm.teachSkill(13100000,20,20); // 보우 마스터리 -- 2차스킬 시작
  cm.teachSkill(13101001,20,20); // 보우 부스터
  cm.teachSkill(13101002,20,20); // 파이널 어택
  cm.teachSkill(13101003,10,10); // 소울 애로우
  cm.teachSkill(13101004,10,10); // 더블 점프
  cm.teachSkill(13101005,20,20); // 스톰 스파이크
  cm.teachSkill(13101006,10,10); // 윈드워크
  cm.teachSkill(13101007,20,20); // 스트레이프
  cm.teachSkill(13111000,20,20); // 애로우 레인 -- 2차스킬 끝
  cm.teachSkill(13100008,10,10); // 피지컬 트레이닝
  cm.teachSkill(13111001,20,20); // 매직 크리티컬 -- 3차스킬 시작
  cm.teachSkill(13111002,30,30); // 폭풍의 시
  cm.teachSkill(13111004,15,15); // 퍼펫
  cm.teachSkill(13111006,20,20); // 윈드 피어싱
  cm.teachSkill(13111005,5,5); // 알바트로스
  cm.teachSkill(13111007,15,15); // 윈드샷
  cm.teachSkill(13110008,10,10); // 닷지 -- 3차끝
  cm.sendOk ("스킬마스터가 완료되었습니다.");
  dispose();
