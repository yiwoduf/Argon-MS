...
function start() {
 if (true) {
	    var chat = "#fUI/UIMiniGame.img/custom/check# #fn나눔고딕 Extrabold##fs17##b[System 1]#n\r\n";
            chat += "#fs13##k#e#L1#"+k+"Delivery#l#L2#"+k+"EQPBKP#L3#"+k+"Storage#l#L4#"+k+"Exchange#l#n\r\n\r\n";
            chat += "#fUI/UIMiniGame.img/custom/check# #fn나눔고딕 Extrabold##fs17##b[System 2]#n\r\n";
            chat += "#fs13##k#e#L5#"+k+"Pet Shop#l#L6#"+k+"Bank#l#L7#"+k+"Rank#l#L8#"+k+"Guild#l#n\r\n\r\n";
			chat += "#fUI/UIMiniGame.img/custom/check# #fn나눔고딕 Extrabold##fs17##b[System 3]#n\r\n";
