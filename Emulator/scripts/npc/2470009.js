...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            cm.sendGetText("얼마를 거실 건가요? #b이길 경우#k 돈을 #r2배#k로 드립니다. #b질 경우#k #r본전#k도 못 찾아갑니다. 수수료 100,000메소는 이기건 지건 빠져나간다는 걸 잊지 마");
        } else if (status == 2) {
            fee = cm.getText();
            ...
            if (cm.getMeso() < fee) {
                ...
                if (chance <= 1) {
                    ...
                    cm.gainMeso(fee * 3);
                    cm.gainMeso(-100000);
                    cm.sendNext("#v4443000##v4443000##v4443000#\r\n게임에서 승리하셨습니다.");
                    cm.dispose();
                }
                else if (chance == 25) {
                    cm.gainMeso(fee * 3);
                    cm.gainMeso(-100000);
                    cm.sendNext("#v4442000##v4442000##v4442000#\r\n게임에서 승리하셨습니다.");
                    cm.dispose();
                }
            }
        }
