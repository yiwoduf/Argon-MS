...
var i = 0;
        ...
        while (transcendence.next()) {
            ...
            print.append("#b"+i).append("위#k ").append(transcendence.getString("name")).append(" #b초월 포인트 :#k ").append(transcendence.getInt("transcendence")).append(" #d직업 :#k ").append(job).append("\r\n");
    }
    cm.sendOk("#fn나눔고딕 Extrabold#"+ServerConstants.serverName+" #b실시간 랭킹#k 입니다.\r\n현재 랭킹은 #fs15##b초월 포인트#k #fs12#로 집계 됩니다.\r\n\r\n"+print.toString());
    cm.dispose();
}
