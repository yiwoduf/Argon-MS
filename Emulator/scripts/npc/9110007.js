...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        */
        ...
        choose += "#L4##fn나눔고딕 ExtraBold##fs 13##e#r[HOT]#k#b추가데미지#k#n\r\n\r\n";
		choose += "#L5000003##fn나눔고딕 ExtraBold##fs 13##e#r[HOT]#k#r벅샷상점\r\n\r\n";
		choose += "#L5##fn나눔고딕 ExtraBold##fs 13##e#r[HOT]#n#e#b후원 강화[25성]#k#n\r\n\r\n";
		choose += "#L1032206##fn나눔고딕 ExtraBold##fs 13##e#b스칼렛상점\r\n\r\n";
		choose += "#L9000344##fn나눔고딕 ExtraBold##fs 13##e#b잠재변경\r\n\r\n";
