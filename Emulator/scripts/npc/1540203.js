...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            cps += "#L100007##fs 13##s4120012##e#r  이지 상점#k";
            cps += "#L100008##fs 13##s4100001##e#r  노멀 상점#n\r\n\r\n";
            cps += "#L10009##fs 13##s1120013##e#r  벼락 상점#k";
            cps += "#L10010##fs 13##s4120002##e#r  코인 상점#n\r\n\r\n";
            cm.sendSimple(cps);         
