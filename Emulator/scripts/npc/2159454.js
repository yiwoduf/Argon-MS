 ...
 */
var list1 = [1051391,1081013,1071077,1050321,1080007,1070060,1702504];//겨울왕국 세트
var list2 = [1002186,1012289,1032024,1022079,1072153,1082102,1102039]; // 투명 세트

var list3 = [1004192,1050335,1051405,1702528,1072943,1112949]; // 멜로디 세트

var list4 = [1003109,1052275,1072448,1102245,1702275]; // 로얄 레인보우
var list5_1 = [1003398,1003399,1003400,1003401,1003402,1004177]; // 기사단장 1세트 + 1004177
var list5_2 = [1702269,1702270,1702271,1702272,1702273]; // 기사단장 2세트
var list6 = [1001075,1051277,1071037,1102356,]; // 시그너스 세트
var list7 = [1003422,1050226,1051276,1070024,1071036,1102355,1702347]; // 비커밍 팬텀 세트
var list8 = [1000050,1001076,1050227,1051278,1702348]; // 윈터 스노우 세트
var list9 = [1000051,1001077,1050228,1051279,1072646,1102367,1702437]; // 엘븐 스피릿
...
var list30 = [1002945,1042165,1062114,1702216,1112905,1112906]; // 커플 세트
var list31 = [1003945,1050296,1051362,1072852,1102608,1702451]; // 슈퍼스타 세트
var list32 = [1003953,1050298,1051365,1072859,1102616,1102617]; // 신의 아이 세트
var list33 = [1003776,1052587,1082493,1702454]; // 퍼펙트 하프물범 세트
var list34 = [1003957,1003958,1050300,1051367,1072862,1102619]; // 아이스 썸머 세트
var list35 = [1003965,1052661,1082549,1702461]; // 꼬꼬닭 세트
var list36 = [1003971,1003972,1050302,1051369,1072868,1102621,1702464]; // 메이드 버클러 세트
var list37 = [1003955,1050299,1051366,1072860,1082555,1702456]; // 마스터 페어리 세트
var list38 = [1003968,1052667,1082552,1072867,1702467]; // 폭신폭신 구름양 세트
var list39 = [1003951,1051374,1072857,1003952,1051375,1072858]; // 오데트/오딜 네로 세트
var list40 = [1004003,1004004,1052074,1082166,1072742,1702478]; // 그레이/핑크 네로 세트
var list41 = [1003998,1050304,1051372,1072876,1082565,1702468]; // 초코퐁듀 세트
var list42 = [1004000,1052674,1072877,1082560,1702471]; // 어둠의 소악마 세트
var list43 = [1004002,1050305,1051373,1070057,1071074]; // 암염의 속죄자 세트
var list44 = [1002962,1002973,1050153,1051182,1072748,1102620,1702487]; // 이국적인 축제 세트
var list45 = [1000069,1001092,1050311,1051383,1072901,1102667]; // 은월 세트
var list46 = [1003853,1082524,1072817,1004081,1052655,1072856]; // blavy엔젤3/소울베어3 세트
var list47 = [1000070,1001093,1050312,1051384,1082580,1072908,1702488]; // 마스터 포니 세트
var list48 = [1000072,1001095,1050310,1051382,1072897,1102669,1702485]; // 쇼퍼홀릭 세트
var list49 = [1000074,1001097,1050319,1051390,1070059,1071076,1702503]; // 버블버블 소풍 세트
var list50 = [1004117,1050318,1051389,1702501]; // 프로포즈 세트
var list51 = [1004158,1050322,1051392,1070061,1071078,1102688]; // 파티 다이어리 세트
var list52 = [1004139,1082587,1052754,1102685,1702505]; // 핑크 판다 토끼 세트
var list53 = [1004180,1042319,1062207,1082588,1072934,1702523]; // 호이포이 무지개 세트
var list54 = [1003089,1072443,1082272,1051209,1050168,1702426]; // 에반 세트
var list55 = [1004294,1052841,1102754,1012485,1702547]; // 단감 세트
var list56 = [1002665,1052137,1702524,1112930,1012028]; // 토마토 세트
var list57 = [1004336,1102766,1052852,1004337,1052853,1102767]; // 폭주 세트
var list58 = [1004327,1050346,1051415,1102758,1073011,1702549]; // 치어리더 세트
var list59 = [1000076,1001098,1050339,1051408,1102729,1072978,1702538]; //초롱초롱세트
var list60 = [1001100,1051420,1101000,1071080,1000079,1050351,1100004,1070064,1702553]; //매디컬 할로윈 세트
var list61 = [1000077,1050343,1001099,1051411,1702519]; //딜런and로잘리아
var list62 = [1004279,1051410,1102748,1072998,1702540]; //캠핑세트
var list63 = [1004250,1050340,1051409,1702530]; //달콤한 여름 세트
var list64 = [1004213,1050337,1051406,1102712,1072951,1702535]; //하와이안 세트
var list65 = [1004411,1051422,1081014,1702561,1071081,1070065];//스위트 파티셰 세트
var list66 = [1004453,1051429,1102811,1070067,1071083,1702570];//눈토끼 세트
var list67 = [1004450,1050356,1051426,1102809,1073041,1702565];//죽음의 세트
var list68 = [1051391,1081013,1071077,1050321,1080007,1070060,1702504];//겨울왕국 세트
/* 
무기5
망토5
...
var listname = ["","겨울왕국 세트","투명 아이템 세트","멜로디 세트","로얄 레인보우 세트","기사단장 세트","시그너스 세트","비커밍 팬텀 세트","윈터 스노우 세트","엘븐 스피리 세트","마린 보이/걸 세트","로얄 네이비 세트","아쿠아 세트","핑크/블랙 수피아 세트","천공의 시엘/퓨전 한복 세트","꽃도령 세트","꽃아씨/늘푸른 사또 세트","인형의 집/핑크엔젤 세트","엘리자베스/나폴레옹 세트","샤오슈 토끼 세트","식목일 세트","서큐버스 세트#r(여)#b","아기양 잠옷 세트","오후의 홍차 세트","제논틱 세트","골프 세트","금방울 세트","샐리맨더 세트#r(여)#b","메이플 야구 세트","시원한 바다 세트","커플세트","슈퍼스타 세트","신의 아이 세트","퍼펙트 하프물범 세트","아이스 썸머 세트","꼬꼬닭 세트","메이드/버클러 세트","마스터 페어리 세트","폭신폭신 구름양 세트","오데트/오딜 네로 세트#r(여)#b","그레이/핑크 네로 세트","초코퐁듀 세트","어둠의 소악마 세트","암염의 속죄자 세트","이국적인 축제 세트","은월 세트","Blavy 엔젤/소울베어 세트","마스터 포니 세트","쇼퍼홀릭 세트","버블버블 소풍 세트","프로포즈 세트","파티 다이어리 세트","핑크 판다 세트","호이포이 무지개 세트","에반 세트","단감 세트","토마토 세트","폭주자매세트","치어리더세트","초롱초롱세트","매디컬 할로윈 세트","딜런and로잘리아","캠핑세트","달콤한 여름세트","하와이안 세트","스위트 파티셰 세트","눈토끼 세트","죽음의 세트","업그레이드 무기","업그레이드 세라핌","테스트"]
        
var seclist = [1112135,1112141,1112142,1112144,1112146,1112148,1112150,1112149.1112151,1112154,1112145,1112155,1112151,1112143,1112238,1112252,1112253,1112256,1112258,1112259,1112262,1112261,1112266,1112257,1112267,1112263,1112254];

var caps = [1004029,1003492,1003493,1003494,1003495,1003496,1003131,1003132,1003133,1003846,1003847,1003860,1003873,1003874,1003875,1003876,1003877,1003878,1004034,1003542,1003543,1003544,1003545,1003546,1003547,1004026,1004027,1004028,1003807,1003954,1003901, 1004120,1004164,1004165,1004166,1004167,1004168,1004169,1004170,1004171,1004175,1004176,1003836,1003837,1003838,1003839];

//1042294
var accessory_1 = [1022188,1022174,1022177,1022230,1022229,1022223];
var accessory_2 = [1012450,1012374,1012415,1012379,1012176,1012384,1012468];
...
var capes = [1102546,1102547,1102548,1102376,1102377,1102378,1102307,1102308,1102309,1102466,1102572,1102624,1102630,1102450,1102451,1102643,1102511,1102629,1102615,1102625, 1102675,1102250,1102695,1102694,1102700,1102644,1102674,1003836,1003837,1003838,1003839];

var weapon = [1702291,1702361,1702365,1702364,1702155,1702196,1702211,1702400,1702366,1702398,1702416,1702397,1702458,1702461,1702464,1702469,1702470,1702471,1702473,1702477,1702478,1702480,1702497,1702502,1702512,1702519,1702521,1702525,1702528,1702529,1702530,1702541,1702550,1702551,1702554,1702555]

var seclistname = ["","명찰 반지 아이템","말풍선 반지 아이템","업그레이드 모자","업그레이드 모자","업그레이드 악세사리","업그레이드 상의","업그레이드 하의","업그레이드 한벌옷","업그레이드 망토","업그레이드 무기"];
...
function action(mode,type,selection) {
	...
	showSecondShop();
        ...
        cm.sendGetNumber("메소로 환전을 원하시는 후원포인트를 입력해주세요\r\n#r※ 1 후원포인트#k = #b5000 메소#k",1,1,cm.getPlayer().getRC());
	...
	if (selection % 1000 != 0) {
	sendHint("정해진 후원포인트의 단위에 맞추어 적어주세요.\r\n#r※ 1000 후원포인트#k = #b올스텟 ＋50#k",50,100);
	cm.dispose();
	} else {
	cost += selection;
	allstat = selection/1000 * 50;
	allstatprice = selection;
	cm.sendGetNumber("\r\n#e선택 아이템#n : #i"+itemid+"# #z"+itemid+"#\r\n#e아이템 가격#n : #b#e"+cost+"#n 후원포인트#k\r\n\r\n#e#Cgray#※ "+allstatprice+" 후원포인트 = 올스텟 ＋"+allstat+" #k#n\r\n#r※ 1500 후원포인트#k = #b공격력/마력 ＋15#k",1,1,cm.getPlayer().getRC());
}
}
	} else if (status == 3) {
	if (selected == 999999) {
	if (selection % 1000 != 0) {
	sendHint("정해진 후원포인트의 단위에 맞추어 적어주세요.\r\n#r※ 1000 후원포인트#k = #b올스텟 ＋500#k",270,30);
	cm.dispose();
	} else {
	cost += selection;
	allstat = selection/1000 * 50;
	...
	if (selection % 1500 != 0) {
	sendHint("정해진 후원포인트의 단위에 맞추어 적어주세요.\r\n#r※ 1500 후원포인트#k = #b공격력/마력 ＋75#k",270,30);
	cm.dispose();
	} else {
	cost += selection;
	atk = selection/1000 * 10;
	atkprice = selection;
...
function showInfo() {
	...
	text += showItemList(53,0,list53,list53.length,true);
	text += showItemList(54,0,list54,list54.length,true);
	text += showItemList(55,0,list55,list55.length,true);
	text += showItemList(56,0,list56,list56.length,true);
	text += showItemList(57,0,list57,list57.length,true);
	text += showItemList(58,0,list58,list58.length,true);
	text += showItemList(59,0,list59,list59.length,true);
	text += showItemList(60,0,list60,list60.length,true);
	text += showItemList(61,0,list61,list61.length,true);
	text += showItemList(62,0,list62,list62.length,true);
	text += showItemList(63,0,list63,list63.length,true);
	text += showItemList(64,0,list64,list64.length,true);
	text += showItemList(65,0,list65,list65.length,true);
	text += showItemList(66,0,list66,list66.length,true);
	text += showItemList(67,0,list67,list67.length,true);
	cm.sendSimple(text);
}

function showSecondShop() {
	var i;
	var info = "(가격 : #Cgray#1000#r + ＠#Cgray#후원포인트#k)\r\n";
	var text = "#d이전 페이지로 돌아가려면 ESC를 눌러주세요.#k\r\n\r\n";
	text += "#e#b["+seclistname[1]+"]#k#n " + info;
	for (i = 0; i < 13; text += "#L"+seclist[i]+"##i"+seclist[i]+"##l",i++);
	text += "\r\n\r\n\r\n#e#b["+seclistname[2]+"]#k#n " + info;	
	for (i = 13; i < 26; text += "#L"+seclist[i]+"##i"+seclist[i]+"##l",i++);
