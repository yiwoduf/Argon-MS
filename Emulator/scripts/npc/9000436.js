...
function action(mode,type,selection){
    ...
    if (status == 0){
		//cm.sendOk("아직은 이용하실 수 없습니다.")
        cm.sendYesNo("#k의자상점에 오신걸 환영해요.\r\n의자상점에서는 #b각종 희귀한 의자#k가 나온답니다!#k#n\r\n\r\n이용하시려면 #i" + spenditem + "# #b#z" + spenditem + "##k 이 필요합니다.");
    }else if (status == 1){
        if (cm.haveItem(spenditem, 1)){
            ...
            cm.sendOk("#i"+spenditem+"##b에이플러스코인#k 을 가지고있지 않습니다.");
            cm.dispose();
        }    
    }    
}