...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			if (selection == 1) {
				var warp = "어느 마을로 이동하시겠습니까?\r\n\r\n";
				warp += "#e#b빅토리아 아일랜드#n#k\r\n";
				warp += "#L104000000#리스항구#l";
				warp += "#L100000000#헤네시스#l";
				warp += "#L101000000#엘리니아#l";
				warp += "#L103000000#커닝시티#l";
				//warp += "#L105000000#슬리피우드#l";
				warp += "#L102000000#페리온#l\r\n\r\n\r\n";
			
				warp += "#e#r오시리아 대륙#n#k\r\n";
				warp += "#L200000000#오르비스#l";
				warp += "#L211000000#엘나스#l";
				warp += "#L260000000#아리안트#l";
				warp += "#L261000000#마가티아#l";
				warp += "#L240000000#리프레#l\r\n";
				warp += "#L310000000#에델슈타인#l";
				//warp += "#L00#백초마을#l";
				//warp += "#L16#무릉#l";
				warp += "#L220000000#루디브리엄#l";
				warp += "#L224000000#아랫마을#l";
				warp += "#L230000000#아쿠아리움#l\r\n";
				warp += "#L241020000#크리티아스#l";
				warp += "#L270000000#시간의 신전#l";
				cm.sendSimple(warp);
