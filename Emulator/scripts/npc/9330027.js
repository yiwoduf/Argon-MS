...
switch(day){
    case 0:
        var d = "성장의 일";
        var item = [2450042,2210133,4001432,4001431,4001431]; //매일 프골티1개 골티2개
        break;
    case 1:
        var d = "창조의 월";
        var item = [2431256,4001432,4001431,4001431];
        break;
    case 2:
        var d = "강화의 화";
        var item = [2049704,2049704,2049704,2049704,4001432,4001431,4001431];
        break;
    case 3:
        var d = "인기의 수";
        var item = [5121047,5121047,5121047,5121047,5121047,2430143,2430143,4001432,4001431,4001431];
        break;
    case 4:
        var d = "랜덤의 목";
        var item = [4001780,4001432,4001431,4001431];
        break;
    case 5:
        var d = "황금의 금";
        var item = [4001715,4001715,4001432,4001431,4001431];
        break;
    case 6:
        var d = "축제의 토";
        var item = [2430686,4310108,2450042,4001432,4001431,4001431];
        break;
    default:
}
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var text = "#fn나눔고딕 Extrabold##fs13# #bAURORA ONLINE#k을 재밋게 즐기고 계신가요?\r\n"
		...
		*/
		...
		text += "#fn나눔고딕 Extrabold##fs13# #L9#나의 등급을 확인한다.#l\r\n"
        ...
        var check = ""
        if (selection == 0) {
            check += "#fn나눔고딕 Extrabold##fs13# #b"+d+"요일#k의 출석체크를 하시겠습니까?\r\n"
            check += "#fn나눔고딕 Extrabold##fs13# 오늘의 보상은 다음과 같습니다.\r\n\r\n#b"
			...
			cm.sendOk("#fn나눔고딕 Extrabold##fs13# 당신의 등급은 #r#e" +cm.getPlayer().getKeyValue("등급")+ "#n#k 등급입니다.#k#l\r\n\r\n");
			cm.dispose();
	...
	if (getWeekly_Check() != day) {
		...
		if (getReturnAttend() == 7) {
            ...
            fin += "#fn나눔고딕 Extrabold##fs13# #b#h0##k님은 이미 #b"+d+"요일#k의 출석을 완료했습니다.\r\n"
            fin += "#fn나눔고딕 Extrabold##fs13# 내일 다시 찾아와 주세요."
        }
        cm.sendOk(fin);
        cm.dispose();
        return;
