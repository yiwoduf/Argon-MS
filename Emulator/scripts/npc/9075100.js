...
var status = -1;
var sel = 0;
var essok = Array ("여기는 에델슈타인의 레벤 광산 지하의 연구실입니다. 이볼빙 시스템을 진행하실 수 있습니다.",
"이볼빙 시스템은 육체의 완전한 진화를 목적으로 만들어진 훈련 시스템입니다. 진화를 위한 모든 환경적 요건은 사용자에 맞출 수 있게 구성되며 모든 과정은 이볼빙 시스템에서 지원하는 가상세계에서 이루어집니다.",
"이볼빙 시스템을 통제하는 인공지능 제어장치 ESS입니다. 사용자의 편리를 위해 이와 같은 형태를 띄고 있습니다.",
"시스템의 오류로 이전 자료는 확인할 수 없습니다.",
...
function action(mode, type, selection) {
	...
	//cm.getPlayer().send(MainPacketCreator.sendPacket("CB 00 03 00 01 04 00 02"));
	cm.dispose();
	} else if(selection == 1) {
	...
	chatq += "#L4#이볼빙 시스템 안내 프로그램을 보고싶어.#l\r\n";
	chatq += "#L5#코어가 뭐야?#l";
	cm.sendSimple(chatq);
		} 
	} else if (status == 2) {
