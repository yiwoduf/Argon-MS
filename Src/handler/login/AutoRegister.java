...
public class AutoRegister {
    ...
    private static int ENABLE_IP_COUNT = 3; //허용 가능한 IP갯수 
    ...
    public static void registerAccount(MapleClient account, String name, String password) {
        ...
        try {
            connect = MYSQL.getConnection();
            query = connect.prepareStatement("INSERT INTO accounts (name, password, 2ndpassword, using2ndpassword, ip) VALUES (?, ?, ?, ?, ?)", MYSQL.RETURN_GENERATED_KEYS);
            query.setString(1, name);
