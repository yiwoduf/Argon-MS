...
public class WorldCommunity {
    ...
    public static boolean 아르미 = false;
    private static java.util.Timer 아르미타임 = null;
    ...
    public static void 아르미() {
        아르미 = true;
        아르미캔슬();
        WorldBroadcasting.broadcastMessage(MainPacketCreator.startMapEffect("아르미 : 우와~ 예쁜 폭죽이 터졌어요!.", 5120124, true));
        WorldBroadcasting.broadcastMessage(MainPacketCreator.getGMText(11, "아르미 : 우와~ 예쁜 폭죽이 터졌어요!"));
    }

    public static void 아르미캔슬() {
