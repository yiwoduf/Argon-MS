...
public class ChracterTransfer implements Externalizable {
    public int nMixBaseHairColor;
    public int nMixAddHairColor;
    public int nMixHairBaseProb;
    public int itcafetime;
    public int damageskinslot;
    public int hp, characterid, accountid, fame, str, dex, int_, luk, maxhp, maxmp, mp, hpApUsed, mpApUsed,
            ...
            mount_level, mount_itemid, mount_Fatigue, mount_exp, reborns, subcategory, headtitle, cardStack, fatigue, petAutoHP, petAutoMP, exeedCount, loginpoint;
    ...
    public Object quickslot, evolving, saveDamageSkin;
    public long damage;
    ...
    public int rankpoint, gp, Soul, betaclothes, karta;
    ...
    public ChracterTransfer(final MapleCharacter chr) {
        ...
        this.nMixBaseHairColor = chr.getMixBaseHairColor();
        this.nMixAddHairColor = chr.getMixAddHairColor();
        this.nMixHairBaseProb = chr.getMixHairBaseProb();
        this.itcafetime = chr.getInternetCafeTime();
        this.damageskinslot = chr.getDamageSkinSlot();
        this.saveDamageSkin = chr.getSaveDamageSkins();
        this.damage = chr.getAddDamage();
        this.damagehit = chr.getAddDamageHit();
        this.freejob = chr.getFreeJob();
    ...
    public void readExternal(final ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        this.nMixBaseHairColor = in.readInt();
        this.nMixAddHairColor = in.readInt();
        this.nMixHairBaseProb = in.readInt();
        this.itcafetime = in.readInt();
        this.damageskinslot = in.readInt();
        this.saveDamageSkin = in.readObject();
        this.damage = in.readLong();
        this.damagehit = in.readInt();
        this.freejob = in.readInt();
    ...
    public void writeExternal(final ObjectOutput out) throws IOException {
        ...
        out.writeInt(this.nMixBaseHairColor);
        out.writeInt(this.nMixAddHairColor);
        out.writeInt(this.nMixHairBaseProb);
        out.writeInt(this.itcafetime);
        out.writeInt(this.damageskinslot);
        out.writeObject(this.saveDamageSkin);
        out.writeLong(this.damage);
        out.writeInt(this.damagehit);
        out.writeInt(this.freejob);
