...
public class MapleLifeProvider {
    ...
    private static final MapleDataProvider data = MapleDataProviderFactory.getDataProvider(new File("property/Wz/Mob.wz"));
    private static final MapleDataProvider stringDataWZ = MapleDataProviderFactory.getDataProvider(new File("property/Wz/String.wz"));
    private static final MapleDataProvider etcDataWZ = MapleDataProviderFactory.getDataProvider(new File("property/Wz/Etc.wz"));
    ...
    public static final List<Pair<Integer, Long>> finalMaxHpMonster = new ArrayList<Pair<Integer, Long>>();
    ...
    public static MapleMonster getMonster(int mid) {
        ...
        if (stats == null) {
            ...
            for (Pair<Integer, Long> fmhm : finalMaxHpMonster) {
                if (mid == fmhm.left) {
                    stats.setFinalMaxHP(fmhm.right);
                }
            }
