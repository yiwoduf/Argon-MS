...
public class MobSkillFactory {
    ...
    private static MapleDataProvider dataSource = MapleDataProviderFactory.getDataProvider(new File("property/Wz/Skill.wz"));
    ...
    public static MobSkill getMobSkill(int skillId, int level) {
        ...
        if (skillData != null) {
            ...
            if (skillId == 201) {
                ...
                mId = -1;
                for (int j = 0; j < i; j ++) {
                    int mobid = MapleDataTool.getInt("fixedDir/" + j, skillData, -1);
                    Point pos = MapleDataTool.getPoint("fixedPos/" + j, skillData, null);
                    if (pos != null) {
                        ret.addMonster(ml.get(mobid), pos);
                    }
                }
            }
