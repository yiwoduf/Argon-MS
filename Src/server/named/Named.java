        ...
        public void run() {
            ...
            if (countdown_ii == 0 && countdown_ss == 0) {
                try {
                    ...
                    WorldBroadcasting.broadcastMessage(MainPacketCreator.getGMText(30, "[¸ÞÀÌÇÃ¿Â¶óÀÎ »ç´Ù¸®¾Ë¸²] " + times + "È¸Â÷ ³×ÀÓµå È¦,Â¦ °á°ú´Â [" + getScoreString(start_point + " " + line_count + " " + odd_even) + "] ÀÔ´Ï´Ù."));
