...
public class CashItemFactory {
    ...
    public MapleDataProvider petData = MapleDataProviderFactory.getDataProvider(new File("property/Wz/Item.wz/Pet"));
    public MapleDataProvider data = MapleDataProviderFactory.getDataProvider(new File("property/Wz/Etc.wz"));
    ...
    protected CashItemFactory() {
        for (MapleData field : data.getData("Commodity.img").getChildren()) {
            ...
            int period = 0;
            if (itemId >= 5000000 && itemId <= 5002000) { //펫
