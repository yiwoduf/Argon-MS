...
public class AramiaFireWorks {
    ...
    private void broadcastEvent(final MapleCharacter c) {
	    WorldBroadcasting.broadcast(MainPacketCreator.serverNotice(5, "<Channel " + c.getClient().getChannel() + "> Aramia from Henesys park will shoot up the firecrackers soon!"));
