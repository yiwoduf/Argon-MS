...
public class MonsterStatusEffect {
    ...
    public MonsterStatusEffect(final Map<MonsterStatus, Integer> stati, final ISkill skillId, final int skillLevel, final MobSkill mobskill, final boolean monsterSkill) {
