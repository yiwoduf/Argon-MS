...
public class TestMobSkillFactory {

    private final Map<Pair<Integer, Integer>, TestMobSkill> mobSkillCache = new HashMap<Pair<Integer, Integer>, TestMobSkill>();
    private static final TestMobSkillFactory instance = new TestMobSkillFactory();

    public TestMobSkillFactory() {
        initialize();
    }

    public static TestMobSkillFactory getInstance() {
        return instance;
    }

    public static TestMobSkill getMobSkill(int skillId, int level) {
    ...
    private TestMobSkill get(ResultSet rs) throws SQLException {
        ...
        final TestMobSkill ret = new TestMobSkill(rs.getInt("skillid"), rs.getInt("level"));
