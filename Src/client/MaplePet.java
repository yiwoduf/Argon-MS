...
public class MaplePet {
    ...
    private int Fh = 0, stance = 0, fullness = 100, level = 1, closeness = 0, skillValue = 0, buffSkillId = 0, uniqueid, petitemid, flags, color = -1;
    private Point pos;
    ...
    public final void saveToDb() {
        try {
            final PreparedStatement ps = MYSQL.getConnection().prepareStatement("UPDATE pets SET name = ?, level = ?, closeness = ?, fullness = ?, pet_skill = ?, pet_buff = ?, expiredate = ?, color = ? WHERE uniqueid = ?");
